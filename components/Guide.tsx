  ...
  return (
    <section className="flexCenter flex-col">
      <div className=" max-container padding-container w-full pb-24">
        ...
        <p className="uppercase regular-18 -3t-1 mb-3 text-green-50">we are here for you</p>
      ...
      <div className="flexCenter max-container relative w-full border-2 border-full-500">
        ...
        <div className="absolute flex bg-white py-8 pl-5 pr-7 rounded-3xl gap-3 border shadow-md md:left-[5%] lg:top-20">
          ...
          <div className="flexBetween flex-col">
            <div className="flex w-full flex-col">
              ...
              <p className="bold-20 mt-2">Sharavati Backwaters</p>
              </div>

              <div className="flex w-full flex-col">
                <p className="regular-16 text-gray-20">Start Trek</p>
              <p className="bold-20 mt-2 whitespace-nowrap">Kalsa</p>
              </div>
            </div>
